...
public class FXTimer extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        button.setOnAction(new EventHandler() {
            ...
            public void handle(Event event) {
                if (timeline != null) {
                    ...
                    timeline.play();
                    Timeline splitTimeline = new Timeline(
                    		new KeyFrame(Duration.millis(100),
                    				new EventHandler<ActionEvent>(){
                    ...
                    splitTimeline.setCycleCount(Timeline.INDEFINITE);
                    splitTimeline.play();
                }
            }
        });
        ...
        vb.getChildren().addAll(button, timerLabel, splitTimerLabel, stopButton, restart);
